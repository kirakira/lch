...
\begin{itemize}
    ...
    \item Failure model.
        ...
        \footnotetext{
        Although git and Mercurial are capable of storing data on multiple servers, this operation is not supported natively and users will need to push data to every single place manually.
...
In the rest of this report we discuss the various trade-offs in when we design LCH, and we share our experience in implementing it.
